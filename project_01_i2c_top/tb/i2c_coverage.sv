class coverage extends uvm_subscriber#(seq_item);
	...
	covergroup cg;
		...
		cp_m_tx_data : coverpoint tr.m_tx_data {
			bins tx_zero 	= {8'h00};
			bins tx_0		= {[8'h01:8'h31]};
	
			bins tx_2		= {[8'h32:8'h63]};

			bins tx_4		= {[8'h64:8'h95]};

			bins tx_6		= {[8'h96:8'hc7]};

			bins tx_8		= {[8'hc8:8'hf9]};
		...
		cp_s_tx_data : coverpoint tr.s_tx_data {
			bins s_tx_zero 	= {8'h00};
			bins s_tx_0		= {[8'h01:8'h31]};
	
			bins s_tx_2		= {[8'h32:8'h63]};

			bins s_tx_4		= {[8'h64:8'h95]};

			bins s_tx_6		= {[8'h96:8'hc7]};

			bins s_tx_8		= {[8'hc8:8'hf9]};

			bins s_tx_10		= {[8'hfa:8'hfe]};
			bins s_tx_max  	= {8'hff};
		}
	endgroup
